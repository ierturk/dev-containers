...
ARG TORADEX_SNAPSHOT=20210426T171318Z
...
ARG DEBIAN_SNAPSHOT
RUN echo "deb [check-valid-until=no] http://snapshot.debian.org/archive/debian/$DEBIAN_SNAPSHOT bullseye main contrib non-free\n\
deb [check-valid-until=no] http://snapshot.debian.org/archive/debian/$DEBIAN_SNAPSHOT bullseye-updates main contrib non-free\n\
deb [check-valid-until=no] http://snapshot.debian.org/archive/debian-security/$DEBIAN_SNAPSHOT bullseye-security main contrib non-free" >/etc/apt/sources.list
